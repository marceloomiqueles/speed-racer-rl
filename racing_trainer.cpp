    ...
    auto get_stage_params = [&](CurriculumStage stage) -> StageParams {
        switch (stage) {
            ...
            case CurriculumStage::Clean:
                return {"clean", 6.0e-4f, 0.35f, 0.020f, 0.997f, 0.10f, 0.0040f, 12.0f, 2.2f, 0.0085f, 90.0f, 780.0f, 300.0f, 3350.0f, 0.0f, 0.0f, 0.0f, 680.0f, 620.0f};
            ...
            case CurriculumStage::Corner:
                return {"corner", 2.0e-4f, 0.10f, 0.005f, 0.999f, 0.12f, 0.0060f, 16.0f, 2.8f, 0.0100f, 80.0f, 700.0f, 210.0f, 2800.0f, 0.004f, 0.0018f, 0.20f, 640.0f, 500.0f};
        }
