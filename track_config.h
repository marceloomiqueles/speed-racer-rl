...
inline std::vector<TrackCheckpoint> SandboxCheckpoints() {
    return {
        {{450.0f, 36.0f},  {450.0f, 152.0f}},
        {{718.0f, 260.0f}, {852.0f, 260.0f}},
        {{850.0f, 665.0f}, {722.0f, 665.0f}},
        {{522.0f, 482.0f}, {626.0f, 517.0f}},
        {{409.0f, 438.0f}, {295.0f, 413.0f}},
        {{161.0f, 732.0f}, {218.0f, 812.0f}},
        {{140.0f, 600.0f}, {49.0f, 600.0f}},
        {{139.0f, 205.0f}, {50.0f, 205.0f}}
    };
}
